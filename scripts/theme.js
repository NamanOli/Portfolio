...
const setDarkTheme = () => {
  ...
  colorPallete.style.setProperty("--off-whit", "#251e1e");
  colorPallete.style.setProperty("--full-whit", "black");
...
const setLightTheme = () => {
  ...
  colorPallete.style.setProperty("--off-whit", "#F1F1F1");
  colorPallete.style.setProperty("--full-whit", "#ffff");
